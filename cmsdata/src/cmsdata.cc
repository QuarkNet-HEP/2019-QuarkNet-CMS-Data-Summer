...
// Class:      cmsdata
//
/**\class cmsdata cmsdata.cc Demo/cmsdata/src/cmsdata.cc
...
class cmsdata: public edm::EDAnalyzer {
public:
        explicit cmsdata(const edm::ParameterSet&);
        ~cmsdata();
...
cmsdata::cmsdata(const edm::ParameterSet& iConfig) {
...
void cmsdata::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
