// -*- C++ -*-
//
// Package:    DimuonSpectrum2012
// Class:      DimuonSpectrum2012
//
/**\class DimuonSpectrum2012 DimuonSpectrum2012.cc Demo/DimuonSpectrum2012/src/DimuonSpectrum2012.cc
...
class DimuonSpectrum2012: public edm::EDAnalyzer {
public:
        explicit DimuonSpectrum2012(const edm::ParameterSet&);
        ~DimuonSpectrum2012();
...
DimuonSpectrum2012::DimuonSpectrum2012(const edm::ParameterSet& iConfig) {
...
DimuonSpectrum2012::~DimuonSpectrum2012() {
...
void DimuonSpectrum2012::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
} //DimuonSpectrum2012: analyze ends


// ------------ method called once each job just before starting event loop  ------------
void DimuonSpectrum2012::beginJob() {

}

// ------------ method called once each job just after ending the event loop  ------------
void DimuonSpectrum2012::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(DimuonSpectrum2012);                                                                            
